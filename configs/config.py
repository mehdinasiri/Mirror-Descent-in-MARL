...
def get_config():
    ...
    # mdpo parameters
    parser.add_argument("--kl_lr", type=float,
                        default=None, help='kl-divergence learning rate (default: None)')
    parser.add_argument("--mdpo_epoch", type=int,
                        default=10, help='number of mdpo epochs (default: 10)')
